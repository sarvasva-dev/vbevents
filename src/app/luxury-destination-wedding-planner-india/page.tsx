...
// Service + FAQPage schema — matches visible FAQ section below
const serviceSchema = {
  ...
  description: 'End-to-end luxury destination wedding planning across palace venues in Udaipur, Jaipur, Goa, and internationally — with NDA-by-default discretion protocols.',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'For luxury destination weddings — especially those involving exclusive palace or fort venue buyouts — we recommend engaging at least 9–12 months in advance. This allows adequate time for venue procurement, international guest logistics, vendor curation, and our NDA-based discovery process. For smaller intimate events, 4–6 months may suffice.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes — always. Every engagement with Vision Beyond Events begins with a mutual non-disclosure agreement before any logistical detail, budget range, venue preference, or family information is discussed. This is our standard protocol, not an optional add-on.',
      },
    },
    {
      '@type': 'Question',
        ...
        <section className="relative pt-40 pb-24 px-6 md:px-20 border-b border-[#d4af37]/20 bg-transparent">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="font-body-md text-[#475569] text-xl leading-relaxed max-w-3xl mb-12">
              Vision Beyond Events is India&apos;s discreet luxury destination wedding planner — architecting palace weddings, fort celebrations, and lakeside estate ceremonies for UHNWI families and global clients. Every engagement begins with an NDA. Every detail is executed with military precision.
            </p>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-0">
                {[
                  ...
                  { step: '02', title: 'Concept & Design', desc: 'We translate your vision into a multi-day event architecture — thematic design language, venue categories, décor tone, and guest experience flow.' },
                  { step: '03', title: 'Vendor Curation', desc: 'We source from a pre-vetted network of artisans, chefs, performers, and production specialists — all contracted under NDA on a need-to-know basis.' },
          ...
          <section className="py-24 px-6 md:px-20 glass-card border-x-0 border-y border-[#d4af37]/20 backdrop-blur-md rounded-none shadow-none">
            <div className="max-w-7xl mx-auto">
              <div className="mb-16">
                ...
                <p className="font-body-md text-[#475569] text-lg mt-4 max-w-2xl">
                  We work across India&apos;s most exceptional heritage properties — all accessed through long-standing relationships and handled with the discretion their owners demand.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  { icon: 'villa', title: 'Private Havelis', desc: 'Intimate heritage havelis for 50–150 guest celebrations. Boutique, bespoke, and completely private.' },
                ].map(({ icon, title, desc }) => (
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link href="/udaipur-destination-wedding-planner" className="inline-flex items-center gap-2 font-body-md text-label-lg uppercase tracking-widest text-[#d4af37] hover:text-[#0f172a] transition-colors text-sm">
              ...
              {[
                {
                  ...
                  a: 'For luxury destination weddings — especially those involving exclusive palace or fort venue buyouts — we recommend engaging at least 9–12 months in advance. This allows adequate time for venue procurement, international guest logistics, vendor curation, and our NDA-based discovery process. For smaller intimate events, 4–6 months may suffice.',
                },
                {
                ...
                },
                {
                  ...
                  a: 'Yes — always. Every engagement with Vision Beyond Events begins with a mutual non-disclosure agreement before any logistical detail, budget range, venue preference, or family information is discussed. This is our standard protocol, not an optional add-on.',
                },
                {
