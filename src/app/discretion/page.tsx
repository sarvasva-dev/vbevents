...
export default function DiscretionPage() {
  return (
    <main className="min-h-screen bg-[#faf9f6] pt-24 pb-20">
      <Navbar />
      {/* Hero Section */}
      <section className="relative px-6 md:px-20 py-24 border-b border-[#d4af37]/30 bg-gradient-to-b from-[#ffffff] to-[#111c38]">
      ...
      <section className="px-6 md:px-20 py-24 border-b border-[#d4af37]/30">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6 font-body-md text-[#475569] leading-relaxed text-lg text-justify">
              <p>
          ...
          <div className="relative h-[600px] bg-[#ffffff] border border-[#d4af37]/30 p-12 flex flex-col justify-center items-center text-center">
            ...
            <h3 className="font-headline-sm text-2xl text-white mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Absolute Anonymization</h3>
      ...
      <section className="px-6 md:px-20 py-24 bg-[#ffffff]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="font-body-md text-[#475569] text-lg max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="border border-[#d4af37]/30 p-8 bg-[#faf9f6] hover:bg-[#1a1a1a] transition-colors">
              ...
              <h3 className="font-headline-sm text-xl text-white mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Power Redundancy</h3>
            ...
            <div className="border border-[#d4af37]/30 p-8 bg-[#faf9f6] hover:bg-[#1a1a1a] transition-colors">
              ...
              <h3 className="font-headline-sm text-xl text-white mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Medical Standby</h3>
              <p className="font-body-md text-[#475569] text-sm leading-relaxed">
            ...
            <div className="border border-[#d4af37]/30 p-8 bg-[#faf9f6] hover:bg-[#1a1a1a] transition-colors">
              ...
              <h3 className="font-headline-sm text-xl text-white mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Weather Mitigation</h3>
              <p className="font-body-md text-[#475569] text-sm leading-relaxed">
            ...
            <div className="border border-[#d4af37]/30 p-8 bg-[#faf9f6] hover:bg-[#1a1a1a] transition-colors">
              ...
              <h3 className="font-headline-sm text-xl text-white mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Security Coordination</h3>
              <p className="font-body-md text-[#475569] text-sm leading-relaxed">
          ...
          <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-[#d4af37]/30 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 border border-[#d4af37]/30 bg-[#ffffff]">
                <h3 className="font-headline-sm text-xl text-white mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>Discovery & NDA</h3>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 border border-[#d4af37]/30 bg-[#ffffff]">
                <h3 className="font-headline-sm text-xl text-white mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>Compartmentalized Procurement</h3>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 border border-[#d4af37]/30 bg-[#ffffff]">
                <h3 className="font-headline-sm text-xl text-white mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>Perimeter Security & Digital Blackout</h3>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 border border-[#d4af37]/30 bg-[#ffffff]">
                <h3 className="font-headline-sm text-xl text-white mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>Post-Event Data Purge</h3>
      ...
      <section className="px-6 md:px-20 py-24 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-headline-lg text-4xl md:text-5xl text-white mb-8" style={{ fontFamily: 'Playfair Display, serif' }}>Initiate a Secure Dialogue.</h2>
          ...
          <Link href="/contact" className="inline-block border border-[#d4af37] text-[#d4af37] font-body-md text-label-lg uppercase tracking-widest px-10 py-4 hover:bg-[#d4af37] hover:text-[#111c38] transition-colors duration-300">
