    ...
    <main className="min-h-screen bg-transparent pt-24 pb-20">
      ...
      <section className="px-6 md:px-20 py-24 text-center bg-transparent">
        <div className="max-w-3xl mx-auto">
          ...
          <Link href="/contact" className="inline-block border border-[#d4af37] text-[#d4af37] font-body-md text-label-lg uppercase tracking-widest px-10 py-4 hover:bg-[#d4af37] hover:text-[#0f172a] transition-colors duration-300">
