...
export default function DiscretionPage() {
  return (
    <main className="min-h-screen bg-[#111c38] pt-24 pb-20">
      <Navbar />
      {/* Hero Section */}
      <section className="relative px-6 md:px-20 py-24 border-b border-[#d4af37]/20 bg-gradient-to-b from-[#0d1526] to-[#111c38]">
      ...
      <section className="px-6 md:px-20 py-24 border-b border-[#d4af37]/10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[600px] bg-[#0d1526] border border-[#d4af37]/20 p-12 flex flex-col justify-center items-center text-center">
      ...
      <section className="px-6 md:px-20 py-24 bg-[#0d1526]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Redundancy 1 */}
            <div className="border border-[#d4af37]/20 p-8 bg-[#111c38] hover:bg-[#1a1a1a] transition-colors">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-[#d4af37]/30 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              <div className="flex items-center justify-center w-10 h-10 rounded-full border border-[#d4af37] bg-[#111c38] text-[#d4af37] shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow-[0_0_15px_rgba(212,175,55,0.2)] z-10">
                <span className="font-body-md text-sm font-bold">01</span>
              </div>
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 border border-[#d4af37]/20 bg-[#0d1526]">
