        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="aspect-[3/4] relative">
              <Image src="/gallery/haldi_ChatGPT Image Jun 22, 2026, 07_38_25 PM.png" alt="Haldi" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover border border-[#d4af37]/30" />
            </div>
            <div className="aspect-[3/4] relative translate-y-8">
              <Image src="/images/ai_dandiya.png" alt="Sangeet" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover border border-[#d4af37]/30" />
            </div>
          </div>
        </div>
      </section>
